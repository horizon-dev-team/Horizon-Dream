...
/atom/vv_get_header()
	...
	. += "<br><font size='1'><a class='button' href='byond://?_src_=vars;[HrefToken()];rotatedatum=[refid];rotatedir=left'><<</a><a class='button' href='byond://?_src_=vars;[HrefToken()];datumedit=[refid];varnameedit=dir' id='dir'>[dir2text(dir) || dir]</a><a class='button' href='byond://?_src_=vars;[HrefToken()];rotatedatum=[refid];rotatedir=right'>>></a></font>"
